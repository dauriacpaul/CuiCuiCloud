...
if __name__ == '__main__':
    ...
    with col3:
        ...
        if selected_bird in list(df.comName_en):
            st.success(f"The {selected_bird} has been detected in {time_compute} seconds. This prediction consumed {emissions}gCO₂eq")
        else:
            st.error(f"The {selected_bird} has not been detected. The computation tooked {time_compute} seconds. This prediction consumed {emissions}gCO₂eq")
