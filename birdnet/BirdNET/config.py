...
##########################
WORKING_PATH = r'birdnet/'
#MODEL_PATH = 'checkpoints/V2.1/BirdNET_GLOBAL_2K_V2.1_Model' # This will load the protobuf model
MODEL_PATH = WORKING_PATH + r'BirdNET/BirdNET_GLOBAL_2K_V2.1_Model_FP32.tflite'
MDATA_MODEL_PATH = WORKING_PATH + r'BirdNET/BirdNET_GLOBAL_2K_V2.1_MData_Model_FP32.tflite'
LABELS_FILE = WORKING_PATH + r"BirdNET/BirdNET_GLOBAL_2K_V2.1_Labels.txt"
